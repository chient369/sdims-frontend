    ...
    <Card className="h-full">
      ...
      <CardContent className="pt-2">
        <div className="text-center">
          <div className={`text-4xl font-bold ${getColor()}`}>{data.totalOpportunities}</div>
          <div className="text-sm text-gray-500">
            {type === 'new' ? 'Cơ hội mới' : type === 'follow' ? 'Cần theo dõi' : 'Hợp đồng'}
          </div>
        ...
        {type === 'follow' && (
          <div className="flex justify-around mt-3">
            <div className="text-center">
              <div className="w-6 h-6 bg-red-100 text-red-600 rounded-full flex items-center justify-center mx-auto">5</div>
              <div className="text-xs mt-1 text-gray-500">Red</div>
            </div>
            <div className="text-center">
              <div className="w-6 h-6 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center mx-auto">4</div>
